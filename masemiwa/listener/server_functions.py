...
from masemiwa.listener import HTTP_RETURN_CODE_MALFORMED_REQUEST
...
def insert():
    if not __check_if_valid_post_json_request(request, key_to_check='links'):
        ...
        return "use POST and send json data with mime 'application/json' and field 'links'", HTTP_RETURN_CODE_MALFORMED_REQUEST
...
def insert():
    ...
    if not __check_if_valid_post_json_request(request):
        ...
        return "use POST and send json data with mime 'application/json' and field 'link'", HTTP_RETURN_CODE_MALFORMED_REQUEST
